...
// --- 版本資訊 ---
const VERSION = 'v11.18.20 - 響應式完美適配版 (Responsive Fit)'; 
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        <input
                            ...
                            placeholder="請輸入密碼"
                            className="w-full px-4 py-3 text-xl text-center border-2 border-blue-200 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all placeholder-gray-300 text-gray-700"
                            autoFocus
                    ...
                    <button
                        type="submit"
                        disabled={loadingSettings}
                        className={`w-full py-3 rounded-xl text-white text-xl font-bold tracking-wider shadow-lg transition-transform active:scale-95 flex items-center justify-center gap-2
  ...
  const handleAddNewDate = useCallback(async () => {
    ...
    const handleAddNewAssignment = useCallback(async () => {
        ...
        if (isOffline) {
            ...
            setAllAssignmentsByDate(prev => ({
                ...prev,
                [selectedDisplayDate]: [...(prev[selectedDisplayDate] || []), ...newAssignments]
            }));
            return;
        }
